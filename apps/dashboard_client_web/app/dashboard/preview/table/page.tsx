...
export default function TablePreviewPage() {
  ...
  return (
    <main className="p-4 md:p-8 max-w-screen-xl mx-auto">
      ...
      <CategoryTable heading="FX" items={snap.fx.items} />
      <CategoryTable heading="Crypto" items={snap.crypto.items} />
      <CategoryTable heading="Indices" items={snap.indices.items} />
      <CategoryTable heading="Interest Rates" items={snap.rates.items} />
      <CategoryTable heading="Stocks" items={snap.stocks.items} />
    </main>
  )
}
